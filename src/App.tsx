...
function App() {
  ...
  const skills = [
    ...
    { name: 'Angular', level: 90, icon: Server },
    { name: 'JavaScript', level: 88, icon: Code2 },
    { name: 'Node.js', level: 85, icon: Server },
    { name: 'Tailwind CSS', level: 88, icon: Monitor },
    { name: 'HTML5', level: 95, icon: Globe },
    { name: 'CSS3', level: 90, icon: Monitor },
    { name: 'MongoDB', level: 82, icon: Database },
    { name: 'MSSQL', level: 80, icon: Database },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-slate-800">Mohammed Naqhid</span>
            </div>
      ...
      <section id="projects" className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              A showcase of my recent work across different industries and technologies
            </p>
          </div>
